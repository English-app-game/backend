...
import { CLIENT_URL, ROOMS_ROUTE,USERS_ROUTE, GAMETYPE_ROUTE, STATISTICS_ROUTE, MEMORYGAME_ROUTE } from "./config/consts.js";
...
import memoryGameRouter from "./routes/memoryGameRoutes.js";
...
export const initApp = () => {
  ...
  app.use(MEMORYGAME_ROUTE, memoryGameRouter);
